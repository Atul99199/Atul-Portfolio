...
export function Hero() {
  ...
  <ScrollAnimation animateIn="fadeInUp" delay={1 * 1000} initiallyVisible={true}>
      ...
      >
        ...
        <a
          href="https://gitlab.com/atul991949"
          target="_blank"
          rel="noreferrer"
        >
        ...
        <a
          href="https://api.whatsapp.com/send/?phone=%2B9919497824&text=Hello+Atul+I+found+your+contact+through+portfolio+site.%0A%0A"
          target="_blank"
          rel="noreferrer"
        >
